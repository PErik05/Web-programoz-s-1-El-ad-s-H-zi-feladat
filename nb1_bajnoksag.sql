...
-- Létrehozás ideje: 2026. Ápr 25. 18:54
...
--
ALTER TABLE `labdarugo`
  ADD CONSTRAINT `labdarugo_ibfk_1` FOREIGN KEY (`klubid`) REFERENCES `klub` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `labdarugo_ibfk_2` FOREIGN KEY (`posztid`) REFERENCES `poszt` (`id`) ON DELETE SET NULL;
COMMIT;
